...
shell_help_text:
    ...
    data.str "$n = argument n; $rn = shell register n" data.8 10
    data.str "$rdn = shell register n as decimal int" data.8 10
    data.str "$rcn = shell register n as character" data.8 10
    ...
    data.str "dir      | print contents of disk" data.8 10
    data.str "disk     | select disk $0" data.8 10
    data.str "diskrm   | remove disk $0" data.8 10
    data.str "echo     | print $0" data.8 10
    data.str "exit     | exit the shell" data.8 10
    data.str "help     | print this help text" data.8 10
